...
Once built, the output is a single JAR `target/kafka-connect-mq-sink-0.4-SNAPSHOT-jar-with-dependencies.jar` which contains all of the required dependencies.
